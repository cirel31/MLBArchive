...
public enum Position {
    // formalName으로 작성
    PITCHER, CATCHER, FIRST_BASEMAN, SECOND_BASEMAN, THIRD_BASEMAN, SHORTSTOP,LEFT_FIELDER,
    ...
    TWO_WAY_PLAYER, BATTER, RUNNER_ON_FIRST, RUNNER_ON_SECOND, RUNNER_ON_THIRD;
