...
const TeamsPage = () => {
  ...
  const [teamList, setTeamList] = useState<TeamType[]>([
    {'id': 1, 'name': 'ArizonaDiamondbacks', 'logo': ArizonaDiamondbacks, rotationX: 0, rotationY: 0},
    {'id': 2, 'name': 'AtlantaBraves', 'logo': AtlantaBraves, rotationX: 0, rotationY: 0},
    {'id': 3, 'name': 'BaltimoreOrioles', 'logo': BaltimoreOrioles, rotationX: 0, rotationY: 0},
    {'id': 4, 'name': 'BostonRedSox', 'logo': BostonRedSox, rotationX: 0, rotationY: 0},
    {'id': 5, 'name': 'ChicagoCubs', 'logo': ChicagoCubs, rotationX: 0, rotationY: 0},
    {'id': 6, 'name': 'ChicagoWhiteSox', 'logo': ChicagoWhiteSox, rotationX: 0, rotationY: 0},
    {'id': 7, 'name': 'CincinnatiReds', 'logo': CincinnatiReds, rotationX: 0, rotationY: 0},
    {'id': 8, 'name': 'ClevelandGuardians', 'logo': ClevelandGuardians, rotationX: 0, rotationY: 0},
    {'id': 9, 'name': 'ColoradoRockies', 'logo': ColoradoRockies, rotationX: 0, rotationY: 0},
    {'id': 10, 'name': 'DetroitTigers', 'logo': DetroitTigers, rotationX: 0, rotationY: 0},
    {'id': 11, 'name': 'HoustonAstros', 'logo': HoustonAstros, rotationX: 0, rotationY: 0},
    {'id': 12, 'name': 'KansasCityRoyals', 'logo': KansasCityRoyals, rotationX: 0, rotationY: 0},
    {'id': 13, 'name': 'LosAngelesAngels', 'logo': LosAngelesAngels, rotationX: 0, rotationY: 0},
    {'id': 14, 'name': 'LosAngelesDodgers', 'logo': LosAngelesDodgers, rotationX: 0, rotationY: 0},
    {'id': 15, 'name': 'MiamiMarlins', 'logo': MiamiMarlins, rotationX: 0, rotationY: 0},
    {'id': 16, 'name': 'MilwaukeeBrewers', 'logo': MilwaukeeBrewers, rotationX: 0, rotationY: 0},
    {'id': 17, 'name': 'MinnesotaTwins', 'logo':MinnesotaTwins, rotationX: 0, rotationY: 0},
    {'id': 18, 'name': 'NewYorkMets', 'logo': NewYorkMets, rotationX: 0, rotationY: 0},
    {'id': 19, 'name': 'NewYorkYankees', 'logo': NewYorkYankees, rotationX: 0, rotationY: 0},
    {'id': 20, 'name': 'OaklandAs', 'logo': OaklandAs, rotationX: 0, rotationY: 0},
    {'id': 21, 'name': 'PhiladelphiaPhillies', 'logo': PhiladelphiaPhillies, rotationX: 0, rotationY: 0},
    {'id': 22, 'name': 'PittsburghPirates', 'logo': PittsburghPirates, rotationX: 0, rotationY: 0},
    {'id': 23, 'name': 'SanDiegoPadres', 'logo': SanDiegoPadres, rotationX: 0, rotationY: 0},
    {'id': 24, 'name': 'SanFranciscoGiants', 'logo': SanFranciscoGiants, rotationX: 0, rotationY: 0},
    {'id': 25, 'name': 'SeattleMariners', 'logo': SeattleMariners, rotationX: 0, rotationY: 0},
    {'id': 26, 'name': 'StLouisCardinals', 'logo': StLouisCardinals, rotationX: 0, rotationY: 0},
    {'id': 27, 'name': 'TampaBayRays', 'logo': TampaBayRays, rotationX: 0, rotationY: 0},
    {'id': 28, 'name': 'TexasRangers', 'logo': TexasRangers, rotationX: 0, rotationY: 0},
    {'id': 29, 'name': 'TorontoBlueJays', 'logo': TorontoBlueJays, rotationX: 0, rotationY: 0},
    {'id': 30, 'name': 'WashingtonNationals', 'logo': WashingtonNationals, rotationX: 0, rotationY: 0},
  ])
  const handleMouseMove = (id: number, event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
